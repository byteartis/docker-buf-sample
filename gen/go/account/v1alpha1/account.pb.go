...
func file_account_v1alpha1_account_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_account_v1alpha1_account_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_account_v1alpha1_account_proto_msgTypes[1].Exporter = func(v any, i int) any {
